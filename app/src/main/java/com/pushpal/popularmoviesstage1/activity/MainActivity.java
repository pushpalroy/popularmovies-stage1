...
public class MainActivity extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener, MovieClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startLoader();
        fetchLanguages();
        new GetAllFavouriteMoviesAsync().execute();
    }
    ...
    public void onFavouriteSelected() {
        ...
        new FetchFavouriteMoviesAsync().execute();
    }
    ...
    private class GetAllFavouriteMoviesAsync extends AsyncTask<Void, Void, List<Movie>> {
        ...
        protected List<Movie> doInBackground(Void... voids) {
            ...
            List<Movie> favMovies = MovieDatabase.getInstance(MainActivity.this)
                    .getMovieDao()
                    .getAllMovies();
        ...
        @Override
        protected void onPostExecute(List<Movie> moviesReturned) {
            super.onPostExecute(moviesReturned);

            favMovies = moviesReturned;
            // Fetching page 1
            fetchMovies(callPage);
        }
    }

    private class FetchFavouriteMoviesAsync extends AsyncTask<Void, Void, List<Movie>> {
